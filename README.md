...
[![CI](https://github.com/jorgelsc-dev/porthound/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/jorgelsc-dev/porthound/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)

PortHound es un scanner de red distribuido en Python para auditorias autorizadas. Esta nueva generacion usa `wsbuilder` como libreria base de framework HTTP/WebSocket. Soporta modos `master`/`agent`/`standalone`, escaneo TCP/UDP/ICMP/SCTP, banner grabbing, persistencia en SQLite y control por API HTTP + WebSocket.

PortHound is a distributed Python network scanner for authorized security audits. It supports `master`/`agent`/`standalone` modes, TCP/UDP/ICMP/SCTP scanning, banner grabbing, SQLite persistence, and HTTP + WebSocket APIs.
...
Sitio oficial: [porthound.jorgelsc.dev](https://porthound.jorgelsc.dev)
...
Si vas a instalar la version publicada:
...
La CLI publicada en PyPI usa `porthound` como comando principal.
...
- publica `porthound_<version>-<rev>_all.deb`
- publica `porthound_<version>-<rev>.zip`
