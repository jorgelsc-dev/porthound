...
DEFAULT_BANNER_RULES_FILE = resolve_data_file("banner_regex_rules.json")
DEFAULT_BANNER_REQUESTS_FILE = resolve_data_file("banner_probe_requests.json")
DEFAULT_IP_PRESETS_FILE = resolve_data_file("ip_presets.json")
